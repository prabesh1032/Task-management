    ...
    <div class="bg-white rounded-xl border border-gray-100 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-900">New Task</p>
                    <p class="text-xs text-gray-400">Fill in the details to create a task</p>
                </div>
            </div>
        ...
        <form action="{{ route('tasks.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="description" rows="3"
                              ...
                              class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-gray-200
                                     bg-gray-50 text-gray-900 placeholder-gray-400
                                     focus:outline-none focus:ring-2 focus:ring-indigo-500
                                     focus:border-transparent focus:bg-white transition resize-none">{{ old('description') }}</textarea>
                    @error('description')
                    <p class="text-xs text-red-500 flex items-center gap-1">
                        <i class="ri-error-warning-line"></i> {{ $message }}
                    </p>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3">
                ...
                <button type="submit"
                    ...
                    <i class="ri-task-line"></i> Create Task
                </button>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addBtn.addEventListener('click', () => {
        container.insertAdjacentHTML('beforeend', checklistItemHTML());
